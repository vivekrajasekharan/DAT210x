...
def doKMeans(data, clusters=0):
  ...
  coordinates=model.cluster_centers_
  print(coordinates)
#  fig = plt.figure()
#  ax = fig.add_subplot(111)
#  ax.scatter(coordinates[:,0],coordinates[:,1], c='r', marker='x',linewidth=5, alpha=0.2)
