...
#
# .. your code here ..
df= pd.read_csv("D:\Python_Microscoft\DAT210x\Module5\Datasets\Wholesale_customers_data.csv")
df.head(5)
df=df.fillna(0)
#
...
ax.scatter(centroids[:,0],centroids[:,1], c='r', marker='x',linewidth=5, alpha=0.2)
