...
df=pd.read_csv('D:/Python_Microscoft/DAT210x/Module5/Datasets/life_expectancy.csv',delimiter='\t')
df.describe()
df.isnull().sum()
#
...
X_train=df_1986.Year.copy()
X_train=X_train.reshape(-1, 1)
y_train=df_1986.WhiteMale.copy()
...
print ("Actual life expectancy is" , df_2014.iloc[0,1])
...
y_train=df_1986.BlackFemale.copy()
y_train=y_train.reshape(-1, 1)
model.fit(X_train, y_train)
drawLine(model, X_train, y_train, "Black Female")

print ("Actual life expectancy of BlkFml is" , df_2014.iloc[0,4])
