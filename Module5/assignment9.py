...
#
# .. your code here ..
X=pd.read_csv('D:/Python_Microscoft/DAT210x/Module5/Datasets/College.csv', index_col=0)
...
X_train, X_test, y_train, y_test= train_test_split(RnB, Accepted, test_size=0.3, random_state=7)
