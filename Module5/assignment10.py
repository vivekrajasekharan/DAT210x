...
zero=[]
sample_rate=[]
for i in glob.glob ('D://Python_Microscoft/DAT210x/Module5/Datasets/recordings/*.wav'):
    Sound_file=wavfile.read(i)
    Sound_data=Sound_file[1]
    sample_rate.append(Sound_file[0])
    zero.append(Sound_data)
...
wavfile.write('D://Python_Microscoft/DAT210x/Module5/Datasets/recordings/OG.wav', sample_rate, test)
...
X_test=test[0,0:int(Provided_Portion * n_audio_samples)]
...
#
# .. your code here ..
y_test=test[0,X_test.shape[1]:test.shape[1]+1]
...
y_train=train[:,X_test.shape[1]:test.shape[1]+1]
# 
...
wavfile.write('D://Python_Microscoft/DAT210x/Module5/Datasets/recordings/Extrapolated Clip.wav', sample_rate, completed_clip[0])
