...
#
# .. your code here ..
y=pd.read_csv("D:\Python_Microscoft\DAT210x\Module5\Datasets\labels.csv",header=None)
...
knn=KNeighborsClassifier(n_neighbors=5).fit(data_train, label_train)
...
print ("The score is:" ,knn.score(data_test, label_test))
