...
X_train, X_test, y_train, y_test = load('D://Python_Microscoft/DAT210x/Module6/Datasets/optdigits.tes', 'D://Python_Microscoft/DAT210x/Module6/Datasets/optdigits.tra')
...
model=SVC(kernel="rbf", C=1, gamma = 0.001).fit(X_train, y_train)
...
# .. your code here ..
y_guess = model.predict(X_test)
guess_1000th_test_value=model.predict(y_guess[999])
